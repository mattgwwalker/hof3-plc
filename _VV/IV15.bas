//********************************************************************************
// IV15
// This code forms part of the main_loop, thus it is run repetitivly.
//
...
// INPUTS to the subroutine VV
&VVstatus1 = &IV15status1 //   |VVout, |VVmotFault, |VVman
&VVstatus2 = &IV15status2 //   |VVeng, |VVdeeng, |VVautoOut, |VVdelayedAutoOut, 
                          //   |VVdelayedOut, |VVfault, |VVengEnable, 
                          //   |VVdeengEnable, |VVmanEnable, |VVfaultResetEnable
&VVcmd = &IV15cmd
...
// OUTPUTS from the subroutine VV
